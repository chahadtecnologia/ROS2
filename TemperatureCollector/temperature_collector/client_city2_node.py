...
class ClientCity2Node(Node):
    def __init__(self):
        super().__init__("client_city2_node")
    ...
    def callback_temp_server(self):
        if self.current_msg is not None:
            ...
            self.get_logger().info("Temperature Collected by Message Interface: " + self.city2_name_ + ": " + str(self.current_msg.temperature_city2))
            pass
        else:
    ...
    def send_request(self):
        ...
        req.city_name = self.get_parameter("city2").value
    ...
    def response_callback(self, future):
        try:
            ...
            if response.success:
                self.city2_name_ = self.get_parameter("city2").value
                self.get_logger().info("Temperature Collected by Service Interface: " + self.city2_name_ + ": " + str(response.temperature))
            else:
