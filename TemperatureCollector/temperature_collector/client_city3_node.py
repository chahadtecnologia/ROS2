...
class ClientCity3Node(Node):
    ...
    def callback_temp_server(self):
        if self.current_msg is not None:
            ...
            self.get_logger().info("Temperature Collected by Message Interface: " + self.city3_name_ + ": " + str(self.current_msg.temperature_city3))
            pass
        else:
    ...
    def send_request(self):
        ...
        req.city_name = self.get_parameter("city3").value
    ...
    def response_callback(self, future):
        try:
            ...
            if response.success:
                self.city3_name_ = self.get_parameter("city3").value
                self.get_logger().info("Temperature Collected by Service Interface: " + self.city3_name_ + ": " + str(response.temperature))
            else:
